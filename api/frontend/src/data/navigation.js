...
export const endpointGroups = [
  {
    ...
    routes: [
      ...
      ['PUT', '/organization', 'обновить организацию и attachment_id'],
    ],
  },
  {
    name: 'Attachment',
    icon: Files,
    routes: [
      ['POST', '/attachment', 'загрузить файл multipart file, public'],
      ['GET', '/attachment', 'список с page, rows, id, label, type'],
      ['GET', '/attachment/:id', 'скачать исходный файл'],
      ['PUT', '/attachment/:id', 'обновить label/public'],
      ['DELETE', '/attachment/:id', 'удалить attachment'],
      ['GET', '/attachment/:id/render/:target_id', 'отрендерить template по target'],
    ],
  },
  {
    name: 'Department',
