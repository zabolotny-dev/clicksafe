...
var (
	...
	ErrEducationRequired       = errors.New("campaign education is required")
	ErrEducationHTMLRequired   = errors.New("campaign education has no HTML content")
	ErrMessageTypeMismatch     = errors.New("campaign message type mismatch")
	ErrMaxEducationRequired    = errors.New("campaign max education text is required")
	ErrMaxEducationTXTRequired = errors.New("campaign max education has no TXT content")
	ErrTargetPhoneRequired     = errors.New("campaign max target phone is required")
)
